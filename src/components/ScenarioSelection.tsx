...
const scenarios = [
  {
    ...
    title: 'High-Stakes Investment',
    description: 'Evaluate market entry, M&A, or portfolio rebalancing',
    icon: TrendingUp,
  ...
  },
  {
    ...
    description: 'Job change, promotion negotiation, or entrepreneurship',
    icon: Briefcase,
  ...
  },
  {
    ...
    description: 'Contract signing, partnership, or conflict resolution',
    icon: Users,
  ...
  },
  {
    ...
    description: 'Project launch, relocation, or major life decision',
    icon: CalendarIcon,
    ...
    <div className="min-h-screen flex items-center justify-center p-6">
      ...
      >
        <div className="text-center mb-12">
          ...
          >
            Choose the domain for strategic analysis
          </motion.p>
        </div>
            ...
            return (
              ...
              >
                ...
                <div className="mt-6 flex items-center gap-2 text-primary opacity-0 group-hover:opacity-100 transition-opacity">
                  <span className="text-sm font-medium">Analyze Strategy</span>
        ...
        >
          Each analysis is uniquely calibrated to your temporal matrix
        </motion.p>
      </motion.div>
    </div>
  );
